...
namespace ClothingStoreFranchise.NetCore.Common.RabbitMq.Impl
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
            ...
            where THandler : IIntegrationEventHandler<TEvent>
        {
            ...
            _logger.LogInformation("Subscribing to event {EventName} with {EventHandler}", eventName, typeof(THandler));
        ...
        private async Task Consumer_Received(object sender, BasicDeliverEventArgs eventArgs)
        {
            ...
            // This should be handled with a Dead Letter Exchange (DLX) same that in springo boot projects.
